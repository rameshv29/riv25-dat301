...
echo "🚀 Starting PostgreSQL MCP Service deployment..."
...
if [ -z "${TASK_ROLE_ARN}" ]; then
    echo "❌ PostgreSQL MCP Task Role ARN not found"
...
echo ""
echo "🎉 PostgreSQL MCP Service deployment completed successfully!"
echo ""
